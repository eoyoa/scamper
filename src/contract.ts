import {ScamperError, ICE, Value, ErrorData} from './lang.js'

export interface ContractHint {
  expected: string,
  actual?: string
}
export interface ContractErrorData extends ErrorData {
  type: "Contract",
  hint: ContractHint
}
  ...
  required.forEach((arg, i) => {
    if (!contract.params[i].predicate(arg)) {
      throw new ScamperError(
          'Runtime',
          contract.params[i].errorMsg(arg),
          undefined,
          undefined,
          undefined,
